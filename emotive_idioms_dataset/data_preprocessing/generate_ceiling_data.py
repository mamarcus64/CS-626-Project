...
from idioms_benchmark import GermanEmotiveIdioms
...
if __name__ == '__main__':
    import pdb
    # load data
    processed_data_directory = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "processed_data"))
    data = np.load(os.path.join(processed_data_directory, "dummy_data.npy"))
